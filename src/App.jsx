...
import EmployeeDatabaseDemo from "./pages/EmployeeDatabaseDemo";
...
export default function App() {
  ...
  if (currentPage === 'employee-database') {
    return (
      <EmployeeProvider>
        <EmployeeDatabaseDemo onBack={handleBackToDashboard} />
        <Toaster />
      </EmployeeProvider>
    );
  }
  ...
  return (
    <EmployeeProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <button className="text-primary hover:underline ml-1 bg-transparent border-none p-0 cursor-pointer">
                view documentation
              </button>
            </p>
          </div>
        ...
        <EmployeeDatabaseTab onOpen={handleEmployeeDatabaseClick} />
